...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    SimpleCube cube;
    cube.Create(context, swapchain.format());
    ...
    const glm::mat4 view        = glm::lookAt(glm::vec3(0.0f, 1.0f, -3.0f), center, glm::vec3(0.0f, -1.0f, 0.0f));
    ...
    while (!glfwWindowShouldClose(window)) {
        glfwPollEvents();
        {
            ...
            glm::mat4 cubePosition = glm::translate(
                glm::mat4(1.0f), glm::vec3(position[0] / 10.0f, position[1] / 10.0f, position[2] / 10.0f));
        ...
        VkCommandBuffer cmdBuffer = cmdBuffers[swapchainImage.idx];
        {
            ...
            const VkRenderingInfoKHR renderInfo = {
                ...
                .pDepthAttachment     = &depthAttachment, // TASK(4): add depth attachment
