...
void RotatingTetrahedron::create(const Context& context, const VkFormat colorFormat, const uint32_t pushConstantStart)
{
    Cone* cone = new Cone();
    cone->create(context, colorFormat, pushConstantStart);
