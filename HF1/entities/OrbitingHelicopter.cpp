...
void OrbitingHelicopter::create(const Context& context, VkFormat colorFormat, uint32_t pushConstantStart, VkPipeline pipeline )
{
    Cube* helicopterCabin = new Cube(1,true);
    helicopterCabin->create(context, colorFormat, pushConstantStart,pipeline);
    m_helicopterBody->addChild(helicopterCabin);

    Cube* helicopterTail = new Cube(1, true);
    helicopterTail->create(context, colorFormat, pushConstantStart,pipeline);
    ...
    helicopterRotor1->create(context, colorFormat, pushConstantStart,pipeline);
    ...
    helicopterRotor2->create(context, colorFormat, pushConstantStart,pipeline);
